...
def snippet_detail(request):
    ...
    if request.method == 'GET':
        if role == 'user':
            ...
            return render(request,'user/uploadedfiles.html',{'objects':queryset})
        elif role=='admin':
            ...
            queryset = UserFileModel.objects.all()
            serializer_class = UserFileModelSerializer
            return render(request, 'cloud/clouduploadedfiles.html', {'objects': queryset})
...
def usercreateapp(request):
    ...
    return render(request,'user/userappcreations.html',{'objects':dict})
...
def useruploadfile(request,appname):
    ...
    return render(request,'user/uploaddatatocloud.html',dict)

def cldresturl(request):
    return render(request,'cloud/edit.html')

def clddeletefile(request):
    return render(request,'cloud/dlt.html')
